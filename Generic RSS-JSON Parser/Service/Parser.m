...
- (void) requestAsynchronousDataFromRssWith:(NSString*)classname andAlias:(NSDictionary*)alias andURL:(NSString*)mLinkURL
{
    ...
    [request setCompletionBlock:^{
        ...
        RSS_Item* tmp= [self parseRSSString:response withClass:classname andAlias:alias andURL:mLinkURL];
        
        //Delegate response
        // Should be replaced with observer
        [self.delegate performSelector:@selector(processAsynchronousRSSComplete:) withObject:tmp];
    ...
    [request setFailedBlock:^{
        ...
        //Delegate response
        // Should be replaced with observer
        [self.delegate performSelector:@selector(processAsynchronousRSSFailed:) withObject:error];
